...
const questions = [
  ...
  ['Which is the most fun?', 'Hardware Projects', 'Software Projects', 'Server Projects'],
  ['Which do you use the most?', 'HTML', 'Python', 'C'],
  ['Which IDE is the best?', 'VS Code', 'IntelliJ', 'Vim'],
  ['What do you use for email?', 'Gmail', 'Outlook', 'Self-host'],
  ['Where do / would you host your websites?', 'Github', 'Vercel', 'My server'],
  ['What browser do you use?', 'Safari', 'Firefox', 'Chrome (Chromium)'],
  ['Which is the best content creator?', 'PirateSoftware', 'Linus Tech Tips', 'MrWhoseTheBoss'],
